...
class Branch(BaseModel):
	...
	isCashIn = models.BooleanField(default=False, null=True)
	lat = models.DecimalField(max_digits=5, decimal_places=6, null=True)
	lng = models.DecimalField(null=True)
	branchNumber = models.IntegerField(null=True)
	city = models.CharField(max_length=1024)
	name = models.CharField(max_length=1024)
	address = models.CharField(max_length=1024)
	clients = models.CharField(max_length=10, choices=CLIENT_OPTION, default=INDIVIDUAL)
